...
//    getLifecycle().addObserver(cpuImageFrameTimeHelper);
    ...
    getLifecycle().addObserver((LifecycleObserver) renderFrameTimeHelper);//I added these casts
    getLifecycle().addObserver((LifecycleObserver) cpuImageFrameTimeHelper); //Gets rid of errors
